...
impl Default for PlayerConfig {
    fn default() -> Self {
        Self {
            ...
            health_text: true,
            armor_bar: true,
            armor_bar_color: Color32::BLUE,
            player_name: true,
            weapon_icon: true,
            tags: true,
            visible_only: false,
            show_backtrack: false,
            backtrack_color: Color32::from_rgba_unmultiplied(255, 0, 0, 128),
...
pub struct HudConfig {
    ...
    pub fov_circle: bool,
    pub fov_circle_close_color: Color32,
    pub fov_circle_mid_color: Color32,
    pub fov_circle_far_color: Color32,
    pub fov_circle_color: Color32,
    pub sniper_crosshair: bool,
    pub crosshair_color: Color32,
    pub dropped_weapons: bool,
    pub keybind_list: bool,
    pub grenade_trails: bool,
    pub inferno_color: Color32,
...
impl Default for HudConfig {
    fn default() -> Self {
        Self {
            ...
            fov_circle: false,
            fov_circle_close_color: Color32::GREEN,
            fov_circle_mid_color: Color32::YELLOW,
            fov_circle_far_color: Color32::RED,
            fov_circle_color: Color32::WHITE,
            sniper_crosshair: true,
            crosshair_color: Color32::WHITE,
            dropped_weapons: true,
            keybind_list: false,
            grenade_trails: true,
            inferno_color: Color32::from_rgba_unmultiplied(255, 0, 0, 127),
