...
pub struct PawnOffsets {
    ...
    pub flash_alpha: u64,         // f32 (m_flFlashAlpha)
...
pub struct WeaponServicesOffsets {
    ...
    pub active_weapon: u64, // CHandle -> active weapon (m_hActiveWeapon)
}
...
#[derive(Debug, Default)]
pub struct MovementServicesOffsets {
    pub force_on_mask: u64, // u64 (m_nButtonForceOnMask)
}
...
pub struct SmokeOffsets {
    pub did_smoke_effect: u64,   // u8 (m_bDidSmokeEffect)
}
...
pub struct Offsets {
    ...
    pub movement_services: MovementServicesOffsets,
